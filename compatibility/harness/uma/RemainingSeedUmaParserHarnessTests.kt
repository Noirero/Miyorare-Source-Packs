...
internal class LikeMangaParserHarnessTest {
    @Test
    fun sharedLikeMangaParserAndCustomUserAgentExecuteDeterministically() = runBlocking {
        ...
        val context = DeterministicMangaLoaderContext { request ->
            ...
            when {
                ...
                url.host == "likemanga.ink" && url.encodedPath == "/manga/fixture-like-123/" -> FixtureResponse(
                    """
                    <ul class="list-info">
                      <li class="othername"><h2>Fixture Alt</h2></li>
                    </ul>
        ...
        assertTrue(observed.all { it.header("User-Agent") == "Usagi/1 (Android)" })
    }
}
