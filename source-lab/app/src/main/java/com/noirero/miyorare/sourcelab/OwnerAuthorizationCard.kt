...
private sealed interface OwnerAuthorizationUiState {
    ...
    data object VerifyingIdentity : OwnerAuthorizationUiState
...
internal fun OwnerAuthorizationCard(
    ...
    val busy = state is OwnerAuthorizationUiState.VerifyingIdentity ||
    ...
    Card(
        ...
        Column(
            modifier = Modifier.fillMaxWidth().then(Modifier).run { this },
            ...
            Column(
                ...
                when (val current = state) {
                        ...
                        Button(
                            onClick = {
                                scope.launch {
                                    ...
                                    try {
                                        val code = GitHubOwnerAuthentication.requestDeviceCode(clientId)
                                        ...
                                        val identity = GitHubOwnerAuthentication.completeOwnerLogin(clientId, code)
                    ...
                    OwnerAuthorizationUiState.VerifyingIdentity -> {
                        AuthorizationProgress(stringResource(R.string.verifying_github_identity))
                    }
